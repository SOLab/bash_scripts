...
c.TemplateExporter.template_path = ['.', os.path.expanduser("~/Jupyter/nbconvert/nbconvert/templates/")]
...
# variable IPYTHONDIR.
# c.NotebookApp.ipython_dir = u'/home/mag/.config/ipython'
...
c.NotebookApp.password = u'sha1:f131ae0fc0e3:1ad31085b2de50fc6f4d6d70c48c559b2bd3ccaf'
...
# The IPython profile to use.
c.IPKernelApp.profile = u'nbserver'
...
# $HOME/.ipython. This options can also be specified through the environment
# variable IPYTHONDIR.
# c.IPKernelApp.ipython_dir = u'/home/mag/.config/ipython'
...
c.InlineBackend.rc = {'font.size': 10, 'savefig.dpi': 96, 'figure.figsize': (6, 4), 'figure.subplot.bottom': 0.125}
...
c.MappingKernelManager.time_to_dead = 21.0
...
c.NotebookApp.notebook_dir = u'/home/mag/Documents/repos/solab/PySOL/notebooks/'
